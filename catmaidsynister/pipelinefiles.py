...
STYLESHEETS['catmaidsynister'] = {
    'source_filenames': (
        'catmaidsynister/css/*.css',
    ),
    'output_filename': 'css/catmaidsynister.css'
}

JAVASCRIPT = OrderedDict()

JAVASCRIPT['catmaidsynister'] = {
    'source_filenames': (
        'catmaidsynister/js/widgets/*.js',
    ),
    'output_filename': 'js/catmaidsynister.js'
}
